...
app.get("/version", (_req, res) => res.json({ version: "5.5.2", notes: "HWID Laptop Bug Fixed", url: "https://github.com/VoltechFPS-Code/voltechshield-api/releases/download/v5.5.4/VoltechShield_5.5.4_x64_en-US.msi" }));
