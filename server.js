...
app.get("/version", (_req, res) => res.json({ version: "3.0.1", notes: "Desktop Audio and Mic Options, GOXLR Fix", url: "https://github.com/VoltechFPS-Code/voltechshield-api/releases/download/v3.0.1/VoltechShield_3.0.1_x64-setup.exe" }));
