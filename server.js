...
app.get("/version", (_req, res) => res.json({ version: "6.0.4", notes: "", url: "https://github.com/VoltechFPS-Code/voltechshield-api/releases/download/v6.0.4/VoltechShield_6.0.4_x64_en-US.msi" }));
