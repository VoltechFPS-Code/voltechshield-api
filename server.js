...
app.get("/version", (_req, res) => res.json({ version: "5.5.6", notes: "", url: "https://github.com/VoltechFPS-Code/voltechshield-api/releases/download/v5.5.6/VoltechShield_5.5.6_x64_en-US.msi" }));
