...
app.get("/version", (_req, res) => res.json({ version: "5.4.0", notes: "Demo Mode Fixes, Added Sign Out Button in Settings, Bug Fixes for View Full Report Button", url: "https://github.com/VoltechFPS-Code/voltechshield-api/releases/download/v5.4.0/VoltechShield_5.4.0_x64_en-US.msi" }));
