...
app.get("/version", (_req, res) => res.json({ version: "5.0.0", notes: "Major Bug Fixes, Increased Clipping Ability", url: "https://github.com/VoltechFPS-Code/voltechshield-api/releases/download/v5.0.0/VoltechShield_5.0.0_x64-setup.exe" }));
