...
app.get("/version", (_req, res) => res.json({ version: "5.5.1", notes: "Latency map · Benchmark + Optimize tab redesigns · UI zoom control · Tutorial updated", url: "https://github.com/VoltechFPS-Code/voltechshield-api/releases/download/v5.5.1/VoltechShield_5.5.1_x64_en-US.msi" }));
