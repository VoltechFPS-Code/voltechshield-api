...
app.get("/version", (_req, res) => res.json({ version: "5.6.0", notes: "GoXLR Support, Arabic UI Update, Settings Tab Rehauled", url: "https://github.com/VoltechFPS-Code/voltechshield-api/releases/download/v5.6.0/VoltechShield_5.6.0_x64_en-US.msi" }));
