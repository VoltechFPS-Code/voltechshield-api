...
app.get("/version", (_req, res) => res.json({ version: "5.3.9", notes: "", url: "https://github.com/VoltechFPS-Code/voltechshield-api/releases/download/v5.3.9/VoltechShield_5.3.9_x64_en-US.msi" }));
