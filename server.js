...
app.get("/version", (_req, res) => res.json({ version: "5.3.8", notes: "", url: "https://github.com/VoltechFPS-Code/voltechshield-api/releases/download/v5.3.8/VoltechShield_5.3.8_x64_en-US.msi" }));
