...
app.get("/version", (_req, res) => res.json({ version: "4.0.2", notes: "Major Bug Fixes, Increased Clipping Ability", url: "https://github.com/VoltechFPS-Code/voltechshield-api/releases/download/v4.0.2/VoltechShield_4.0.2_x64-setup.exe" }));
